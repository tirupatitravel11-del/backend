...
import {
  ...
  LoginForAdmin,
  signout,
} from "../controllers/createUserByAdmin";
import {
  getAllUsers,
  getSingleUser,
  getUserByRole,
...
import {
  ...
  getSingleCity,
  restoreCity,
} from "../controllers/city/city.controller";
import {
  changeRouteStatus,
  createUpdateRoute,
  deleteRoute,
  ...
  getSingleRoute,
  restoreRoute,
} from "../controllers/route/route.controller";
import {
  createUpdateRouteFare,
  getAllRouteFare,
  getSingleRouteFare,
  deleteRouteFare,
  restoreRouteFare,
  changeRouteFareStatus,
  getRouteFareDropdown,
} from "../controllers/routefare/routeFare.controller";
import { getRoutePage, searchRoute } from "../controllers/web/webapiController";
import {
  changeRouteSeoStatus,
  createUpdateRouteSeo,
  deleteRouteSeo,
  getAllRouteSeo,
  getRouteSeoDropdown,
  getSingleRouteSeo,
...
import { createBulkCabPages, createUpdateCabPage, getCabPageBySlug, getCabPageData } from "../controllers/cabPage/cabPage.controller";
...
//------------------seo---------------------
router.post("/create-update-seo", authMiddleware, createUpdateRouteSeo);
router.post("/get-all-seo", getAllRouteSeo);
router.post("/get-single-seo", getSingleRouteSeo);
router.post("/delete-seo", authMiddleware, deleteRouteSeo);
router.post("/restore-seo", authMiddleware, restoreRouteSeo);
router.post("/change-status-seo", authMiddleware, changeRouteSeoStatus);
router.post("/dropdown-seo", getRouteSeoDropdown);
